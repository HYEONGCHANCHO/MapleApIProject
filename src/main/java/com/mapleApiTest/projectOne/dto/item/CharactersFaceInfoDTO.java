...
public class CharactersFaceInfoDTO {
    ...
    public CharactersFaceInfoDTO(String item_equipment_slot, String itemName, int str, int dex, int intel, int luk, int hp, int attactPower, int magicPower, Double bossDamage, Double ignore, int allStat, String potentialOne, String potentialTwo, String potentialThree, String additionalOne, String additionalTwo, String additionalThree, JsonNode excetional, String soul) {
